...
const FashionSlider = () => {
  ...
  return (
    <div className="relative bg-black py-16 flex justify-center items-center min-h-[90vh] w-full overflow-hidden">
      <Swiper
      ...
      >
          ...
          <SwiperSlide key={idx}>
            {({ isActive }) => (
              <div
                ...
                className="flex flex-col md:flex-row items-center justify-between gap-12 md:gap-0 px-6 md:px-20"
              >
        ...
        <button
          ref={prevRef}
          className="absolute left-20 md:left-[-20px] top-1/2 -translate-y-1/2 z-20 p-4 bg-[#ffd5a3] hover:bg-[#ffe3c2] text-[#222] rounded-full shadow-lg transition-all border-2 border-white/10"
